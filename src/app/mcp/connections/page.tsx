...
import MoniMcpAcceptanceStatusClient from '@/components/MoniMcpAcceptanceStatusClient'
        ...
        <div className="mb-8 flex flex-wrap items-start justify-between gap-4">
          <div>
            ...
            <p className="mt-3 max-w-2xl text-sm leading-6 text-slate-600">
              사전점검 PASS → 최대 30분 수용검사 창 → 실제 OAuth·도구 실행 자동 판정 순서로 진행합니다. ChatGPT가 승인할 도구 스냅샷이 점검 이후 바뀌면 수용검사 창은 자동으로 차단됩니다.
            </p>
          </div>
